...
try:
    ...
    """inputPhone = browser.find_element(By.XPATH, "//div[@class='second_block']/div[1]/input")
    inputPhone.send_keys("+1 555 555 555")

    inputAddress = browser.find_element(By.XPATH, "//div[@class='second_block']/div[2]/input")
